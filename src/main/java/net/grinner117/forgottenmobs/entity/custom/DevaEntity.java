...
public class DevaEntity extends Monster implements Enemy, IAnimatable {
    ...
    public void aiStep() {
        ...
        if (this.tickCount % 600 == 0) {
            this.addEffect(new MobEffectInstance(MobEffects.GLOWING, 600, 0));
        }
    }
    ...
    public boolean hurt(DamageSource source, float amount) {
        if (source.getEntity() instanceof LivingEntity) {
            ((LivingEntity) source.getEntity()).addEffect(new MobEffectInstance(MobEffects.HARM, 20, 0));
        }
