...
public class ShadowAdultDragonEntity extends FlyingMob implements Enemy, GeoEntity {
    ...
    class PhantomCircleAroundAnchorGoal extends ShadowAdultDragonEntity.PhantomMoveTargetGoal {
        ...
        public void start() {
            this.distance = 5.0F + ShadowAdultDragonEntity.this.random.nextFloat() * 10.0F;
