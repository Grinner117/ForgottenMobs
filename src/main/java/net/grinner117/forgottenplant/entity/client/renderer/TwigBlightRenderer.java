...
import net.grinner117.forgottenplant.entity.client.model.TwigBlightModel;
...
public class TwigBlightRenderer extends GeoEntityRenderer<net.grinner117.forgottenplant.entity.custom.TwigBlightEntity> {
    public TwigBlightRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new TwigBlightModel());
        this.shadowRadius = 0.2f;
    }
    @Override
    public ResourceLocation getTextureLocation(net.grinner117.forgottenplant.entity.custom.TwigBlightEntity instance) {
