...
import net.grinner117.forgottenaberration.entity.client.model.beholder.Beholder71Model;
...
public class Beholder71Renderer extends GeoEntityRenderer<net.grinner117.forgottenaberration.entity.custom.Beholder71Entity> {
    public Beholder71Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new Beholder71Model());
        this.shadowRadius = 1.0f;
    }
    @Override
    public ResourceLocation getTextureLocation(net.grinner117.forgottenaberration.entity.custom.Beholder71Entity instance) {
