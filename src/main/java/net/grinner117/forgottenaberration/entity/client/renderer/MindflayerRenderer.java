...
import net.grinner117.forgottenaberration.entity.client.model.MindflayerModel;
...
public class MindflayerRenderer extends GeoEntityRenderer<net.grinner117.forgottenaberration.entity.custom.MindflayerEntity> {
    public MindflayerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new MindflayerModel());
        this.shadowRadius = 1.0f;
    }
    @Override
    public ResourceLocation getTextureLocation(net.grinner117.forgottenaberration.entity.custom.MindflayerEntity instance) {
