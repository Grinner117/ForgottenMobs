package net.grinner117.forgottenaberration.entity.client.renderer.beholder;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import net.grinner117.forgottenaberration.ForgottenAberration;
import net.grinner117.forgottenaberration.entity.client.model.beholder.Beholder72Model;
...
public class Beholder72Renderer extends GeoEntityRenderer<net.grinner117.forgottenaberration.entity.custom.Beholder72Entity> {
    public Beholder72Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new Beholder72Model());
        this.shadowRadius = 1.0f;
    }
    @Override
    public ResourceLocation getTextureLocation(net.grinner117.forgottenaberration.entity.custom.Beholder72Entity instance) {
