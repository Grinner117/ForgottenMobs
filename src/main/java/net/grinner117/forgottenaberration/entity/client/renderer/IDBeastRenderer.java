...
import net.grinner117.forgottenaberration.entity.client.model.IDBeastModel;
...
public class IDBeastRenderer extends GeoEntityRenderer<net.grinner117.forgottenaberration.entity.custom.IDBeastEntity> {
    public IDBeastRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new IDBeastModel());
        this.shadowRadius = 1.0f;
    }
    @Override
    public ResourceLocation getTextureLocation(net.grinner117.forgottenaberration.entity.custom.IDBeastEntity instance) {
